	...
	"collections": {
		"todos": {
            ...
            <p>
                ...
                include in the query results. In this case, only the "title" field of the todos will be included in the results.
            </p>
            <p>
                <span class="tag">pagination</span> This property defines how the query results are paginated. The
                default <span class="tag">limit</span> is set to 15, meaning only 15 results will be returned at a time. Users can set a custom "limit"
